...
def RunConv(conv, Kx, Ky, Sx, Sy, mode, relu_en, feature_in, W, bias,
    ...
    conv.write(0x6c, W.physical_address)
    conv.write(0x78, bias.physical_address)
    conv.write(0x84, feature_out.physical_address)
...
def RunPool(pool, Kx, Ky, mode, feature_in, feature_out):
    ...
    pool.write(0x4c, feature_out.physical_address)
